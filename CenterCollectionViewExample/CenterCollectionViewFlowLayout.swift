...
class CenterCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        print(currentAttributes.center.x - halfWidth)
...
class BetterCollectionViewFlowLayout: UICollectionViewFlowLayout {
override func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
...
//https://github.com/bartoszkaminski/carousel-collection-layout/blob/master/CarouselCollectionLayout/CarouselLayout.swift
